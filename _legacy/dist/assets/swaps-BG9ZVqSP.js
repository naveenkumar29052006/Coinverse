import{i as P,a as C,h as D,N as _,x as u,b as K,e as W,R as S,A as j,d as V,M,f as F,W as Q,r as q,j as H}from"./index-CIxlH4tj.js";import{r as s,n as h,c as E,U as m}from"./if-defined-DrohSjYd.js";import"./index-Ce-WaUFT.js";import{M as L}from"./index-JJdZ6k1w.js";import"./index-CgmWuubT.js";import{S as n}from"./index-DEzqV-6G.js";import"./index-CzRXb_Da.js";import"./index-D3fEQ0_6.js";import"./index-CA3odVZ6.js";import"./auth-BX3w9aTJ.js";import"./vendor-6c6uw9Oj.js";import"./index-YOh7WrZQ.js";import"./index-Bv4HDlEf.js";import"./ref-B1VG13IW.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=c.metaKey||c.ctrlKey,i=c.key,a=i.toLocaleLowerCase(),l=a==="a",x=a==="c",v=a==="v",R=a==="x",U=i===",",O=i===".",B=i>="0"&&i<="9";!r&&(l||x||v||R)&&c.preventDefault(),t==="0"&&!U&&!O&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(U||O)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!O&&!U&&c.preventDefault()}},X=P`
  :host {
    width: 100%;
  }
...
`;var z=function(c,t,e,o){var r=arguments.length,i=r<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(a=c[l])&&(i=(r<3?a(i):r>3?a(t,e,i):a(t,e))||i);return r>3&&i&&Object.defineProperty(t,e,i),i};let N=class extends C{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};N.styles=[Z];z([h()],N.prototype,"target",void 0);N=z([E("w3m-swap-input-skeleton")],N);const J=P`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var w=function(c,t,e,o){var r=arguments.length,i=r<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(a=c[l])&&(i=(r<3?a(i):r>3?a(t,e,i):a(t,e))||i);return r>3&&i&&Object.defineProperty(t,e,i),i};let p=class extends C{constructor(){var t,e;super(),this.unsubscribe=[],this.initialParams=(t=S.state.data)==null?void 0:t.swap,this.detailsOpen=!1,this.caipAddress=j.state.caipAddress,this.caipNetworkId=(e=D.state.activeCaipNetwork)==null?void 0:e.caipNetworkId,this.initialized=n.state.initialized,this.loadingQuote=n.state.loadingQuote,this.loadingPrices=n.state.loadingPrices,this.loadingTransaction=n.state.loadingTransaction,this.sourceToken=n.state.sourceToken,this.sourceTokenAmount=n.state.sourceTokenAmount,this.sourceTokenPriceInUSD=n.state.sourceTokenPriceInUSD,this.toToken=n.state.toToken,this.toTokenAmount=n.state.toTokenAmount,this.toTokenPriceInUSD=n.state.toTokenPriceInUSD,this.inputError=n.state.inputError,this.fetchError=n.state.fetchError,this.onDebouncedGetSwapCalldata=V.debounce(async()=>{await n.swapTokens()},200),D.subscribeKey("activeCaipNetwork",o=>this.onCaipNetworkChange({newCaipNetwork:o,resetSwapState:!0,initializeSwapState:!1})),j.subscribeKey("caipAddress",o=>this.onCaipAddressChange({newCaipAddress:o,resetSwapState:!0,initializeSwapState:!1})),this.unsubscribe.push(D.subscribeKey("activeCaipNetwork",o=>this.onCaipNetworkChange({newCaipNetwork:o,resetSwapState:!1,initializeSwapState:!0})),j.subscribeKey("caipAddress",o=>this.onCaipAddressChange({newCaipAddress:o,resetSwapState:!1,initializeSwapState:!0})),M.subscribeKey("open",o=>{o||n.resetState()}),S.subscribeKey("view",o=>{o.includes("Swap")||n.resetValues()}),n.subscribe(o=>{this.initialized=o.initialized,this.loadingQuote=o.loadingQuote,this.loadingPrices=o.loadingPrices,this.loadingTransaction=o.loadingTransaction,this.sourceToken=o.sourceToken,this.sourceTokenAmount=o.sourceTokenAmount,this.sourceTokenPriceInUSD=o.sourceTokenPriceInUSD,this.toToken=o.toToken,this.toTokenAmount=o.toTokenAmount,this.toTokenPriceInUSD=o.toTokenPriceInUSD,this.inputError=o.inputError,this.fetchError=o.fetchError}))}async firstUpdated(){n.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(t=>t==null?void 0:t()),clearInterval(this.interval)}render(){return u`
    ...
    `}templateTokenInput(t,e){var l,x;const o=(l=n.state.myTokensWithBalance)==null?void 0:l.find(v=>(v==null?void 0:v.address)===(e==null?void 0:e.address)),r=t==="toToken"?this.toTokenAmount:this.sourceTokenAmount,i=t==="toToken"?this.toTokenPriceInUSD:this.sourceTokenPriceInUSD,a=_.parseLocalStringToNumber(r)*i;return u`<w3m-swap-input
...
`;var A=function(c,t,e,o){var r=arguments.length,i=r<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(a=c[l])&&(i=(r<3?a(i):r>3?a(t,e,i):a(t,e))||i);return r>3&&i&&Object.defineProperty(t,e,i),i};let $=class extends C{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(t=>{t.forEach(e=>{e.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){var e;if(!this.visible)return null;const t=this.amount&&this.price?(e=_.multiply(this.price,this.amount))==null?void 0:e.toFixed(3):null;return u`
...
//# sourceMappingURL=swaps-BG9ZVqSP.js.map
