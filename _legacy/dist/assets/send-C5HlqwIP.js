import{i as f,a as w,d as I,h as x,l as H,t as l,x as u,r as z,j as W,R as g,N as L,u as q,S as B,e as F,f as M,W as Y}from"./index-CIxlH4tj.js";import{n as d,r as c,c as m,U as b,o as K}from"./if-defined-DrohSjYd.js";import"./index-Ce-WaUFT.js";import"./index-Bv4HDlEf.js";import{e as O,n as D}from"./ref-B1VG13IW.js";import{n as G,s as J}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-CN988nDr.js";import{S as Q}from"./index-DEzqV-6G.js";import"./index-D3fEQ0_6.js";import"./index-7hSvhAYh.js";import"./index-BsfVAayL.js";import"./index-CA3odVZ6.js";import"./auth-BX3w9aTJ.js";import"./vendor-6c6uw9Oj.js";import"./index-YOh7WrZQ.js";const X=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var j=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var a=o.length-1;a>=0;a--)(s=o[a])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let C=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var e;return(e=this.inputElementRef)!=null&&e.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
    ...
    /> `}dispatchInputChangeEvent(e){var n,r;const i=e.data;if(i&&((n=this.inputElementRef)!=null&&n.value))if(i===","){const t=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=t,this.value=`${this.value}${t}`}else G.test(i)||(this.inputElementRef.value.value=this.value.replace(new RegExp(i.replace(J,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:(r=this.inputElementRef.value)==null?void 0:r.value,bubbles:!0,composed:!0}))}};C.styles=[z,W,Z];j([d({type:Boolean})],C.prototype,"disabled",void 0);j([d({type:String})],C.prototype,"value",void 0);j([d({type:String})],C.prototype,"placeholder",void 0);C=j([m("wui-input-amount")],C);const ee=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
...
//# sourceMappingURL=send-C5HlqwIP.js.map
