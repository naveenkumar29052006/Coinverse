    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex items-center justify-between mt-8 p-6 bg-card rounded-2xl border border-border/50">
                ...
                <Link href="/coins" className="flex items-center gap-2 text-accent hover:text-white px-6 py-3 bg-accent/10 hover:bg-accent/20 rounded-xl transition-all font-medium">
